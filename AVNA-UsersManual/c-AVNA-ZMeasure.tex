...
resistor value,
 ...
 A more elaborate procedure for finding the best reference resistance for a general impedance type
...
\textbf{Measuring an Impedance - }I put together a series combination of a 10 Ohm resistor and a 0.22uF capacitor and put this across theleft Z terminals.  To get started, we can measure this at a single frequency by tapping on the menu item, "Single Freq."
...
The Q value shown of 63.3 is the ratio of the reactance magnitude to the resistance value.  We are accustomed to measuring Q of inductors, and that would be shown here if the reactance was positive.  The Q of a capacitor ihas the same physical meanings as for inductors.
...
\textbf{Swept Impedance Measurements - }  We do not have a graphical presentation of frequency swept impedance data.  Instead we have a tabular listing.
...
Going back to the AVNA main menue, there is a menu item, "What?".  This is handy if the component type or value is unknown, or maybe a quick answer is wanted.  This starts with the following menu that describes what to do.
\begin{figure}[H]
\begin{center}
