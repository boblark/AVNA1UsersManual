...
\usepackage[top=1.0in, bottom=1.0in, left=0.25in, right=0.25in]{geometry}
...
\pagestyle{fancy}
%
\lfoot{\scriptsize{AVNA-UsersManual.tex}}  % Put File Name Here}}
\cfoot{\thepage\ of \pageref{LastPage}}
%\rfoot{\scriptsize{\today}}
\rfoot{\scriptsize{February 9, 2021}}
\lhead{}
\chead{}
\rhead{AVNA1 Documentation V0.84}
%
\title{\textbf{AVNA1 User's Manual}}
...
%
\renewcommand{\abstractname}{Introduction} % Changes "Abstract" to
%                                                   "Introduction"
%
...
\input{c-AVNA-ZMeasure}
\input{e-AVNA-TMeasure}
\input{g-AVNA-VectorVolts}
\input{i-AVNA-Spectrum}
\input{k-AVNA-SigGen}
\input{m-AVNA-NoiseMeasure}
%\input{o-AVNA-Delay}
\input{q-AVNA-ScreenSave}
\input{s-AVNA-Calibration}
\input{t-AVNA-System.tex}
\input{v-AVNA-Serial}
